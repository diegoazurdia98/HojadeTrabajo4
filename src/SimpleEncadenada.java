/*
 * C�digo basado en el de bxacosta, 12 jul 2015
 * Estraido de: "https://github.com/bxacosta/listas_simples_java/tree/master/src/listassimples"
 * */

public class SimpleEncadenada {
    ...
    public void insertarPorReferencia(int referencia, int valor){
        ...
        if (!esVacia()) {
            ...
            if (buscar(referencia)) {
                ...
                Lista siguiente = aux.getSiguiente();
